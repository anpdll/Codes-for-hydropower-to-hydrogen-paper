function lcoh = lcoh_calculation_for_o_n_m(o_n_m,lcoe,operating_hrs,surplus_electricity,r,tr,dr,N,sp_h2,stack_energy_consumption,year)
...
opex = o_n_m.*capex + lcoe.*surplus_electricity;
